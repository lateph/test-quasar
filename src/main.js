...
axios.defaults.baseURL = 'https://apisimap.kppgroup.co.id'
...
export default new VueIdb({
  ...
  schemas: [
    ...
    { sensuss: '++local_id, id, pohon_id, kondisi_id, karyawanid, checked_at, created_by, created_at, updated_by, updated_at, flag, keterangan' },
